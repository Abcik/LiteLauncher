...
public final class LauncherPaths {
    ...
    public static Path modpacksDirectory() {
        return minecraftDirectory().resolve("modpacks");
    }

    public static Path instancesDirectory() {
        return minecraftDirectory().resolve("instances");
    }

    public static Path instanceDirectory(String versionId) {
        String safeId = safeVersionId(versionId);
        return instancesDirectory().resolve(safeId);
    }

    public static Path instanceVersionsDirectory(String versionId) {
        return instanceDirectory(versionId).resolve("versions");
    }
    ...
    public static Path themeColorsFile() {
        return launcherDataDirectory().resolve("theme-colors.json");
    }
    ...
    public static Path elyByDirectory() {
        return launcherDataDirectory().resolve("elyby");
    }

    public static Path elyByAuthlibManifestFile() {
        return elyByDirectory().resolve("ely_manifest.json");
    }

    public static Path elyBySkinCacheDirectory() {
        return elyByDirectory().resolve("skins");
    }

    private static String safeVersionId(String versionId) {
        String value = versionId == null ? "" : versionId.trim();
