...
public final class MicrosoftAuthClient {
    ...
    public MicrosoftProfileData authenticate(String code, String codeVerifier, URI redirectUri) throws AuthException {
        ...
        return new MicrosoftProfileData(session);
    }

    public MicrosoftProfileData refresh(MicrosoftSession session) throws AuthException {
        ...
        return new MicrosoftProfileData(updated);
    }
    ...
    private JsonObject xui(JsonObject response) {
        ...
        Object first = items.isEmpty() ? null : items.get(0);
